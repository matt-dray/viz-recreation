...
I realised the `image()` function in base R could be used to create images made from individual squares, making it possible to recreate pixel-based sprites.
